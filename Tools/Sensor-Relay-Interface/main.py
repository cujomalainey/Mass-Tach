...
if __name__ == '__main__':
    ...
    conf.channel_serial_number.append(1)
    conf.channel_type.append(conf.BIKE_CADENCE)
    conf.channel_serial_number.append(2)
    conf.channel_type.append(conf.BIKE_CADENCE)
    conf.channel_serial_number.append(3)
    conf.channel_type.append(conf.BIKE_CADENCE)
    conf.channel_serial_number.append(4)
    conf.channel_type.append(conf.BIKE_CADENCE)
    conf.channel_serial_number.append(5)
    conf.channel_type.append(conf.BIKE_CADENCE)
    conf.channel_serial_number.append(6)
    conf.channel_type.append(conf.BIKE_SPEED)
    conf.channel_serial_number.append(7)
    conf.channel_type.append(conf.BIKE_SPEED)
    print(conf.SerializeToString())
